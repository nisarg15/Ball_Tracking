...
video = cv.VideoCapture("/home/nisarg/Desktop/ball_video1.mp4")
while True:
    B,frame = video.read()
    if B == True:
        if count < 10:
            cv.imwrite("/home/nisarg/Desktop/ENPM 673 - Perception/Assignment/Homework 1/Project 2/Images/frame0" + str(count) + ".jpg", frame)
            count+=1
            cv.waitKey(30)
        else:
            cv.imwrite("/home/nisarg/Desktop/ENPM 673 - Perception/Assignment/Homework 1/Project 2/Images/frame" + str(count) + ".jpg", frame)
            count+=1
            cv.waitKey(30)
...
filename = [img for img in glob.glob("C:/Users/nisar/Desktop/nisarg15_hw1/Problem 2/Images/*.jpg")]
filename.sort()
